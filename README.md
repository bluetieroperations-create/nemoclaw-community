...
| Blackwall x402 Payment Gate | Gates an agent's x402 payments behind a pre-signature GO/HOLD/STOP verdict service, pairing a narrow OpenShell egress policy with an action-layer check on counterparty reputation, price anomalies, and sanctions. | [Guide](examples/blackwall-x402-payment-gate/README.md) |
